    ...
    <ul class="navbar-nav ml-auto">
     <!-- <li class="nav-item ">
      ...
      <li class="nav-item dropdown d-sm-block d-md-none">
        ...
        <!--    <a class="dropdown-item" href="myposts.php">My articles</a> -->
            <a class="dropdown-item" href="display_article.php">View Articles</a>
        </div>
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
        ...
        <ul class="list-group">
          ...
          <!--  <a href="#submenu2" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
            ...
            <div id='submenu2' class="collapse sidebar-submenu">
                <a href="myposts.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">My articles</span>
                </a>
          ...
          <!--  </div>-->
            ...
            <a href="article.php" class="bg-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span><i class="fa fa-pencil-square-o fa-fw mr-3" aria-hidden="true"></i></span>
                    <span class="menu-collapsed">Post articles</span>
                </div>
            </a>
            <a href="display_article.php" class="bg-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span></span>
